...
class Window(QMainWindow):
    def __init__(self):
        ...
        #self.dayTwoPNG   = QLabel(alignment=Qt.AlignmentFlag.AlignJustify)
        #self.dayThreePNG = QLabel(alignment=Qt.AlignmentFlag.AlignJustify)
        #self.dayFourPNG  = QLabel(alignment=Qt.AlignmentFlag.AlignJustify)
        #self.dayFivePNG  = QLabel(alignment=Qt.AlignmentFlag.AlignJustify)
